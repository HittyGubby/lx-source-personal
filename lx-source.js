...
const handleGetMusicUrl = async (source, musicInfo, quality) => {
  ...
  if (source == 'wy') {
    const request = await httpFetch(`${API_NETEASE}/song/url/v1?id=${songId}&level=standard&cookie=MUSIC_U=${NCM_COOKIE_MUSIC_U}`,
      {
        method: 'GET',
        headers: {
